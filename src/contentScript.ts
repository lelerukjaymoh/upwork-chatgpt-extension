...
const sections = [{
    "section": "Summary",
    "prompt": "summarize this project description"
}, {
    "section": "Major points",
    "prompt": "what are the major points?"
}, {
    "section": "Similar Projects",
    "prompt": "give 3 examples of similar projects"
}, {
    "section": "Understandability",
    "prompt": "how understandable is the project description to a non-technical"
}, {
    "section": "Resources",
...
async function processData(jobDescriptionNode: any, nextNode: any) {
    try {

        const description = jobDescriptionNode.textContent
        ...
        for (let i = 0; i < sections.length; i++) {
            ...
            prompt = i == 0 ? `summarize this project description. ${description}` : section.prompt
